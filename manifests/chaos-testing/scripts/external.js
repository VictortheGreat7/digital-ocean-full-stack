...
const profiles = {
  ...
  load: {
    stages: [
      { duration: '3m', target: 1000 }, // Start with 1500 users
      { duration: '15m', target: 1000 }, // Stay at 1500 users
  ...
  soak: {
    stages: [
      { duration: '5m', target: 2000 }, // Start with 2000 users
      { duration: '3h', target: 2000 }, // Hold for 3 hours
